       ...
       <div align="left">
        ...
        <span class="Etiqueta_user">&nbsp;&nbsp;&nbsp;Bienvenido: ${sessionScope.USUARIO_ACTUAL.nombres}</span>
         ...
         <br/>
          ...
          <table border="0">
           <tr><td align="center"><a href="<%=request.getContextPath()%>/PortalMesaAyuda.action"> <img src="<%=request.getContextPath()%>/images/ayuda2.jpg" width="200" heigth="200" border="0"></a></td></tr>
