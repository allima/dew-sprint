       ...
       <div align="left">
        ...
        <span class="Etiqueta_user">&nbsp;&nbsp;&nbsp;Bienvenido: ${sessionScope.USUARIO_ACTUAL.nombres}</span>
         ...
         <br/>
          ...
          <table border="0">
           <tr><td align="center"><a href="<%=request.getContextPath()%>/MantTickAdmin.action"> <img src="<%=request.getContextPath()%>/images/ayuda2.jpg" width="200" heigth="200" border="0"></a></td></tr>
           <tr><td align="center"><a href="<%=request.getContextPath()%>/MantTickAdmin.action"> Seguimiento de Tickets</a></td>              </tr>
          </table>
          </td>
          <td> <table border="0">
           <tr><td align="center"><a href="<%=request.getContextPath()%>/Mantenimiento.action"> <img src="<%=request.getContextPath()%>/images/mantenimiento_cir.jpg"  width=185" heigth="185" border="0"></a></td></tr>
           <tr><td align="center"><a href="<%=request.getContextPath()%>/Mantenimiento.action">Mantenimiento del Sistema</a></td>              </tr>
          </table>
