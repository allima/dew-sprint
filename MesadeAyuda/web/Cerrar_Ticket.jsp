                ...
                <table width="700" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td width="700" valign="top"><table width="800" border="0" cellpadding="0" cellspacing="0">
                                <!--DWLayoutTable-->
                                <tr>
                                    <td width="821" align="right" valign="bottom"><div class="titulo Estilo6">Cerrar Ticket</div></td>
                                </tr>
                                <tr class="texto">
                                    ...
                                    <td colspan="2" valign="top" bordercolor="#F0F0F0" bgcolor="#FFFFFF"><table width="768" border="0" align="center" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="texto">
                                            ...
                                            <tr valign="middle" bgcolor="#66CC33" class="cabecera">
                                                ...
                                                <td colspan="2" bgcolor="#FFFFFF" scope="col"><table width="345" height="52" border="0">
                                                        <tr>
                                                            ...
                                                            <td width="4">&nbsp;</td>
                                                            <td width="160" bgcolor="#FFFFFF" class="comentario"><label>Soporte Tecnico</label></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;</td>
                                                            <td bgcolor="#FFFFFF" class="comentario"><label>Juan Talara</label></td>
                                            ...
                                            <tr valign="middle" bgcolor="#66CC33" class="cabecera">
                                                ...
                                                <td colspan="4" bgcolor="#FFFFFF" scope="col"><table width="345" height="52" border="0">
                                                        ...
                                                        <tr>
                                                            <td class="cabecera"><hr align="left" width="369" /></td>
                                                        </tr>

                                                        <tr>
                                                            <td  class="cabecera">Descripción de la Solución</td>
                                                        </tr>
                                                        <tr>
