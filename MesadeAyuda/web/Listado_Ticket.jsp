                                    ...
                                    <td colspan="2" valign="top" bgcolor="#FFFFFF">
                                        <table width="800" border="1" align="center" cellpadding="1" cellspacing="0" class="texto">
                                            ...
                                            <tr class="texto">
                                                ...
                                                <td width="23" class="texto" align="center"><a href="<%=request.getContextPath()%>/ConsultarMA.action"><img src="<%=request.getContextPath()%>/images/mod.gif" width="20" alt="Modificar" height="20" border="0" /></a></td>
