    ...
    <table width="800" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="800" valign="top"><table width="800" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr class="texto">
              <td width="800" align="right" valign="bottom"><div align="left"><span class="cabecera">Sofia Melendez Cruz : Mesa de Ayuda</span></div></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td height="25" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="437" height="16" valign="middle"><!--DWLayoutEmptyCell-->&nbsp;</td>
        ...
        <td width="800" valign="top"><table width="800" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td colspan="2" valign="top" bordercolor="#F0F0F0" bgcolor="#FFFFFF"><table width="800" border="0" align="center" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="texto">
                  <tr valign="middle" bgcolor="#66CC33" class="cabecera">
                    ...
                    <td width="74" bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                    <td width="202" bgcolor="#FFFFFF" scope="col"><label></label></td>
                    <td width="1" align="center" bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                    <td width="57" bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                    <td width="163" bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                  </tr>
                  <tr valign="middle" bgcolor="#66CC33" class="cabecera">
          ...
          %>
                  <tr class="texto">
                    ...
                    <td width="23" class="texto" align="center"><a href="javascript:Consultaticket(formulario);"><img src="images/mod.gif" alt="Modificar" width="20" height="20" border="0" /></a></td>
                  </tr>
                  <tr class="texto">
                    <td class="texto" align="center"><input type="checkbox" name="id_check2" id="id_check2" /></td>
                    <td class="texto" align="center">MA000006</td>
                    <td class="texto">Sofia Melendez Cruz</td>
                    <td class="texto"><div align="center">01/02/2010</div></td>
                    <td class="texto"><div align="center">01/02/2010</div></td>
                  ...
                  <tr class="texto">
                    ...
                    <td class="texto" align="center">MA000020</td>
                    <td class="texto">Sofia Melendez Cruz</td>
