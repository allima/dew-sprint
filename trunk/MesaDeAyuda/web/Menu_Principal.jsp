<%@page import="edu.upc.dew.mda.bean.*" %>
...
<center>
  <form name="formulario" method="post" action="ir?a=mantenimiento_applet">
      <% BeanOperador beanOperador = (BeanOperador)request.getSession().getAttribute("beanOperador"); %>
	  <div align="left">
    ...
    <table width="700" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="700" valign="top"><table width="800" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="821" align="right" valign="bottom"><div class="titulo Estilo6">Menu de opciones  </div></td>
            </tr>
            <tr class="texto">
              <td width="821" align="right" valign="bottom"><div align="left"><span class="cabecera"><%= beanOperador.getNombres()+" "+beanOperador.getApellidos()  %> : <%= beanOperador.getPerfil() %></span></div></td>
            </tr>
        </table></td>
      </tr>
      <tr>
            ...
            <tr>
              <td colspan="2" valign="top" bordercolor="#F0F0F0" bgcolor="#FFFFFF"><table width="812" border="0" align="center" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="texto">
                  <tr valign="middle" bgcolor="#66CC33" class="cabecera">
                    <td width="115" align="center" bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                    <td width="212" bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                    <td width="5" bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                    <td colspan="3" bgcolor="#FFFFFF" scope="col"><div align="right">
                      <input name="btnAgregar4" type="button" class="texto" id="btnAgregar4" onclick="javascript:mntasignacion(formulario);" value="Nuevo"/>
                  ...
                  <tr valign="middle" bgcolor="#66CC33" class="cabecera">
                    ...
                    <td bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                    <td width="114" bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                    <td width="160" bgcolor="#FFFFFF" scope="col">&nbsp;</td>
                  ...
                  <tr valign="middle" bgcolor="#66CC33" class="cabecera">
                    <td align="center" bgcolor="#FFFFFF" scope="col"><div align="left">Grupo Asignaci&oacute;n</div></td>
                    <td valign="bottom" bgcolor="#FFFFFF" scope="col"><label>
